...
public class Velocity {
  ...
  public static void main(String... args) {
    ...
    // Conduit: the legacy upstream VersionChecker (which reported against Velocity-CTD's GitHub
    // releases and printed "development build of Velocity-CTD") has been removed. Conduit runs its
    // own modular update checker from Conduit#start, so the startup notice already fired above.
